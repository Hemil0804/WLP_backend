...
module.exports = {
	...
	YOUR_GOOGLE_GEOCODING_API_KEY: key == 'PRODUCTION' ? process.env.YOUR_GOOGLE_GEOCODING_API_KEY : key == 'DEV' ? process.env.YOUR_GOOGLE_GEOCODING_API_KEY : process.env.YOUR_GOOGLE_GEOCODING_API_KEY,
